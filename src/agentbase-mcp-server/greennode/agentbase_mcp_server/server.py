"""FastMCP entry point for the AGENTBASE MCP server."""
...
from greennode.agentbase_mcp_server.example_handler import ExampleHandler
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser = argparse.ArgumentParser(
        description="GreenNode MCP Server -- manage AGENTBASE via MCP"
    )
    parser.add_argument(
        "--allow-write",
        action="store_true",
